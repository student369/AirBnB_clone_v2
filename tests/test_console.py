...
number_bathrooms=2 max_guest=10 price_by_night=300 \
        ...
        with patch('sys.stdout', new=StringIO()) as f:
            ...
            s = f.getvalue()
            self.assertTrue(
                "'longitude': -122.431297" in s and
                "'latitude': 37.773972" in s and
                "'price_by_night': 300" in s and
                "'max_guest': 10" in s and
                "'number_bathrooms': 2" in s and
                "'number_rooms': 4" in s and
                "'name': 'My little house'" in s and
                "'user_id': '0001'" in s and
                "'city_id': '0001'" in s
            )
